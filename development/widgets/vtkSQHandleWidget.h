/*=========================================================================
  ...
  Module:    $RCSfile: vtkSQHandleWidget.h,v $
...
=========================================================================*/
// .NAME vtkSQHandleWidget - a general widget for moving handles
// .SECTION Description
// The vtkSQHandleWidget is used to position a handle.  A handle is a widget
...
// into the vtkSQHandleWidget's widget events:
// <pre>
...
// </pre>
//
// In turn, when these widget events are processed, the vtkSQHandleWidget
...
#ifndef __vtkSQHandleWidget_h
#define __vtkSQHandleWidget_h
...
class VTK_WIDGETS_EXPORT vtkSQHandleWidget : public vtkAbstractWidget
{
public:
  // Description:
  // Instantiate this class.
  static vtkSQHandleWidget *New();

  // Description:
  // Standard VTK class macros.
  vtkTypeRevisionMacro(vtkSQHandleWidget,vtkAbstractWidget);
...
protected:
  ...
  static void GenericAction(vtkSQHandleWidget*);
...
private:
  vtkSQHandleWidget(const vtkSQHandleWidget&);  //Not implemented
  void operator=(const vtkSQHandleWidget&);  //Not implemented
};
