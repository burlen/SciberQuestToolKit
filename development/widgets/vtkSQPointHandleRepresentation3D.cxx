/*=========================================================================
  ...
  Module:    $RCSfile: vtkSQPointHandleRepresentation3D.cxx,v $
...
=========================================================================*/
#include "vtkSQPointHandleRepresentation3D.h"
...
vtkCxxRevisionMacro(vtkSQPointHandleRepresentation3D, "$Revision: 1.17 $");
vtkStandardNewMacro(vtkSQPointHandleRepresentation3D);

vtkCxxSetObjectMacro(vtkSQPointHandleRepresentation3D,Property,vtkProperty);
vtkCxxSetObjectMacro(vtkSQPointHandleRepresentation3D,SelectedProperty,vtkProperty);


//----------------------------------------------------------------------
vtkSQPointHandleRepresentation3D::vtkSQPointHandleRepresentation3D()
{
  // Initialize state
...
//-------------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::PlaceWidget(double bds[6])
{
  int i;
...
//-------------------------------------------------------------------------
double* vtkSQPointHandleRepresentation3D::GetBounds()
{
  return this->Cursor3D->GetModelBounds();
}

//-------------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::SetWorldPosition(double p[3])
{
...
//-------------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::SetDisplayPosition(double p[3])
{
  if (this->Renderer && this->PointPlacer)
    { 
...
//-------------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::SetHandleSize(double size)
{
...
//-------------------------------------------------------------------------
int vtkSQPointHandleRepresentation3D
...
//-------------------------------------------------------------------------
int vtkSQPointHandleRepresentation3D::DetermineConstraintAxis(
...
void vtkSQPointHandleRepresentation3D::StartWidgetInteraction(double startEventPos[2])
{
...
// of the widget.
void vtkSQPointHandleRepresentation3D::WidgetInteraction(double eventPos[2])
{
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::MoveFocus(double *p1, double *p2)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
void vtkSQPointHandleRepresentation3D::Translate(double *p1, double *p2)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::SizeBounds()
{
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::Scale(double *p1, double *p2, double eventPos[2])
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::Highlight(int highlight)
{
  if ( highlight )
    {
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::CreateDefaultProperties()
{
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::BuildRepresentation()
{
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::ShallowCopy(vtkProp *prop)
{
  vtkSQPointHandleRepresentation3D *rep = 
    vtkSQPointHandleRepresentation3D::SafeDownCast(prop);
  if ( rep )
    {
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::GetActors(vtkPropCollection *pc)
{
  this->Actor->GetActors(pc);
}

//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::ReleaseGraphicsResources(vtkWindow *win)
{
  this->Actor->ReleaseGraphicsResources(win);
}

//----------------------------------------------------------------------
int vtkSQPointHandleRepresentation3D::RenderOpaqueGeometry(vtkViewport *viewport)
{
...
//-----------------------------------------------------------------------------
int vtkSQPointHandleRepresentation3D::RenderTranslucentPolygonalGeometry(
...
//-----------------------------------------------------------------------------
int vtkSQPointHandleRepresentation3D::HasTranslucentPolygonalGeometry()
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
void vtkSQPointHandleRepresentation3D::PrintSelf(ostream& os, vtkIndent indent)
{
