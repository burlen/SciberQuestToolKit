/*=========================================================================
  ...
  Module:    $RCSfile: vtkSQPointHandleRepresentation3D.h,v $
...
=========================================================================*/
// .NAME vtkSQPointHandleRepresentation3D - represent the position of a point in 3D space
// .SECTION Description
...
#ifndef __vtkSQPointHandleRepresentation3D_h
#define __vtkSQPointHandleRepresentation3D_h
...
class VTK_WIDGETS_EXPORT vtkSQPointHandleRepresentation3D : public vtkHandleRepresentation
{
public:
  // Description:
  // Instantiate this class.
  static vtkSQPointHandleRepresentation3D *New();

  // Description:
  // Standard methods for instances of this class.
  vtkTypeRevisionMacro(vtkSQPointHandleRepresentation3D,vtkHandleRepresentation);
...
protected:
  vtkSQPointHandleRepresentation3D();
  ~vtkSQPointHandleRepresentation3D();
...
private:
  vtkSQPointHandleRepresentation3D(const vtkSQPointHandleRepresentation3D&);  //Not implemented
  void operator=(const vtkSQPointHandleRepresentation3D&);  //Not implemented
};
