...
(define
  (axes2 inFile outFile xLow xHigh nMajorX nMinorX labelFreqX yLow yHigh nMajorY nMinorY labelFreqY majorWidth majorLength minorWidth minorLength tickPrecision tickFontFace tickFontSize tickFontColor xLabel yLabel labelFontFace labelFontSize labelFontColor figlet figletFontFace figletFontSize figletFontColor)
    (let*
      ...
      ; helper to print to an error log
      (define
        (log-name-value name val port)
        (let* ()
          (display name port)
          (display "=" port)
          (if (number? val)
            (begin
              (display (number->string val) port)
            )
            (begin
              (display val port)
            )
      ...
      ; open log
      (set! lf (open-output-file "axes.log"))
      (log-name-value "inFile" inFile lf)
      (log-name-value "outFile" outFile lf)
      (log-name-value "xLow" xLow lf)
      (log-name-value "xHigh" xHigh lf)
      (log-name-value "nMajorX" nMajorX lf)
      (log-name-value "nMinorX" nMinorX lf)
      (log-name-value "labelFreqX" labelFreqX lf)
      (log-name-value "yLow" yLow lf)
      (log-name-value "yHigh" yHigh lf)
      (log-name-value "nMajorY" nMajorY lf)
      (log-name-value "nMinorY" nMinorY lf)
      (log-name-value "labelFreqY" labelFreqY lf)
      (log-name-value "majorWidth" majorWidth lf)
      (log-name-value "majorLength" majorLength lf)
      (log-name-value "minorWidth" minorWidth lf)
      (log-name-value "minorLength" minorLength lf)
      (log-name-value "tickPrecision" tickPrecision lf)
      (log-name-value "tickFontFace" tickFontFace lf)
      (log-name-value "tickFontSize" tickFontSize lf)
      (log-name-value "tickFontColor" tickFontColor lf)
      (log-name-value "xLabel" xLabel lf)
      (log-name-value "yLabel" yLabel lf)
      (log-name-value "labelFontFace" labelFontFace lf)
      (log-name-value "labelFontSize" labelFontSize lf)
      (log-name-value "labelFontColor" labelFontColor lf)
      (log-name-value "figlet" figlet lf)
      (log-name-value "figletFontFace" figletFontFace lf)
      (log-name-value "figletFontSize" figletFontSize lf)
      (log-name-value "figletFontColor" figletFontColor lf)
