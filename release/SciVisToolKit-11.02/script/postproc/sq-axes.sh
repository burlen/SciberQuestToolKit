...
then
  exe=`basename $0`
  echo "Error: $exe" 1>&2
  echo "inFile outFile xLow xHigh nMajorX nMinorX labelFreqX yLow yHigh nMajorY nMinorY labelFreqY majorTickWidth majorTickLength minorTickWidth minorTickLength tickPrecision tickFontSize tickFontColor tickFontFace"  1>&2
  exit -1
fi
